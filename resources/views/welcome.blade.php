...
@section('content')
    ...
    <div class="welcome-hero">
        <div class="container text-center py-5">
            ...
            <div class="d-flex gap-3 justify-content-center">
                <button id="infoButton" class="btn btn-warning">Acerca de este sitio</button>
            </div>
        </div>
    </div>
    ...
    <div class="container my-5">
        ...
        <form id="contacto" class="mx-auto" style="max-width: 600px;">
            <div class="mb-3">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const boton = document.getElementById("infoButton");

        if (boton) {
            boton.addEventListener("click", function () {
                alert(`Proyecto desarrollado por AS19014, TM22012, GR22081, LG22018 ,CG92088
`);
            });
        }
    });
