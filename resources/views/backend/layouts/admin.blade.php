...
<body>
    <div class="d-flex">
        ...
        <h4 class="text-center mb-4 d-flex align-items-center justify-content-center"><img src="images/fav-icon-cine-catalogo.png" alt="Ícono" style="height: 24px; width: 24px; margin-right: 8px;">CineCatálogo</h4>
